namespace source
{
    ...
    public class SenderMachineService
    {
        ...
        public SenderMachineService(string connString, string deviceId)
        {
        ...
        public async Task Start(Guid runId, SenderMachineConfigData config)
        {
